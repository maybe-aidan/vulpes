...
/*
 * Fires an event to listeners of the given code. If an event handler returns TRUE, the event is considered
 * handled and is not passed on to any more listeners.
